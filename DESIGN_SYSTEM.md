...
Foundation package ปัจจุบันมี 39 components:

| กลุ่ม | Components |
|---|---|
| Actions | `Button` |
| Forms | `TextField`, `Textarea`, `Select`, `Checkbox`, `Radio`, `Switch`, `FormField`, `NumberInput`, `CurrencyInput`, `Combobox`, `DatePicker`, `MultiSelect` |
